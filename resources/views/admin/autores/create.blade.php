        ...
        <div class="flex items-center justify-between w-full gap-4">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <h1 class="text-lg font-black text-slate-900 dark:text-white">Novo Autor</h1>
                </div>
            </div>
    ...
    <div class="-mx-4 px-4 py-10 bg-slate-50 dark:bg-[#0f172a] sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8 min-h-screen relative">
        ...
        <div class="fixed inset-0 z-0 pointer-events-none overflow-hidden" aria-hidden="true">
            <svg class="absolute inset-0 w-full h-full" xmlns="http://www.w3.org/2000/svg">
                <defs>
                    <pattern id="bg-dots-autores-create" width="28" height="28" patternUnits="userSpaceOnUse">
                        <circle cx="1" cy="1" r="1" fill="#93c5fd" opacity="0.08"/>
                    </pattern>
                </defs>
                <rect width="100%" height="100%" fill="url(#bg-dots-autores-create)"/>
            </svg>
            ...
            <i class="ph ph-pen-nib bg-icon absolute left-[3%] top-[5%] text-[28px]"></i>
        ...
        <div class="lg:col-span-7 flex flex-col justify-center">
            ...
            <div class="mb-8 border-b border-gray-700 pb-4">
                <h2 class="text-3xl text-slate-900 dark:text-white tracking-tight uppercase font-black" style="font-family: 'Merriweather', serif;">
                    Novo <span class="text-[#F59E0B]">Autor</span>
                </h2>
            </div>
            ...
            <form method="POST" action="{{ route('autores.store') }}" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="group">
                        ...
                        <input id="nacionalidade" type="text" name="nacionalidade" value="{{ old('nacionalidade') }}"
                            class="block w-full bg-white dark:bg-gray-900 border border-slate-200 dark:border-gray-700 text-slate-900 dark:text-white focus:border-[#F59E0B] focus:ring-1 focus:ring-[#F59E0B] rounded-md shadow-sm transition-all duration-300 hover:border-slate-300 dark:hover:border-gray-500" />
                    </div>
                </div>
                ...
                <div class="group">
                    ...
                    <input id="data_nascimento" type="date" name="data_nascimento" value="{{ old('data_nascimento') }}"
                        class="block w-full bg-white dark:bg-gray-900 border border-slate-200 dark:border-gray-700 text-slate-900 dark:text-white focus:border-[#F59E0B] focus:ring-1 focus:ring-[#F59E0B] rounded-md shadow-sm transition-all duration-300 hover:border-slate-300 dark:hover:border-gray-500" />
                </div>
                ...
                <div class="group">
                    ...
                    <textarea id="biografia" name="biografia" rows="4"
                        class="block w-full bg-white dark:bg-gray-900 border border-slate-200 dark:border-gray-700 text-slate-900 dark:text-white focus:border-[#F59E0B] focus:ring-1 focus:ring-[#F59E0B] rounded-md shadow-sm transition-all duration-300 hover:border-slate-300 dark:hover:border-gray-500">{{ old('biografia') }}</textarea>
                </div>
                ...
                <div class="bg-slate-100 dark:bg-gray-900/50 p-4 border border-dashed border-slate-300 dark:border-gray-600 rounded-md hover:border-[#F59E0B] transition-colors duration-300">
                    <label for="foto" class="block text-xs font-bold text-slate-600 dark:text-gray-400 uppercase tracking-wider mb-3">Foto do Autor</label>
                ...
                <div class="bg-white dark:bg-gray-900 border border-slate-200 dark:border-gray-700 shadow-xl rounded-md overflow-hidden flex flex-col max-w-sm mx-auto h-[480px] transition-all duration-500 hover:shadow-2xl hover:border-slate-300 dark:hover:border-gray-500 hover:-translate-y-2">
                    ...
                    <div class="p-4 flex-1">
                        <div class="text-center mb-4">
                            <div class="w-20 h-20 bg-slate-200 dark:bg-gray-700 rounded-full mx-auto mb-2 flex items-center justify-center">
                                <i class="ph ph-user text-2xl text-slate-600 dark:text-gray-400"></i>
                            </div>
                            <h3 class="text-lg font-bold text-slate-900 dark:text-white" id="prev-nome">Nome do Autor</h3>
                            <p class="text-slate-600 dark:text-gray-400 text-sm" id="prev-nacionalidade">Nacionalidade</p>
                        </div>

                        <div class="space-y-2 text-sm">
                            <div>
                                <span class="text-slate-600 dark:text-gray-500">Data de Nascimento:</span>
                                <span class="text-slate-900 dark:text-white" id="prev-data">Não informada</span>
                            </div>
                        </div>

                        <div class="mt-4">
                            <p class="text-slate-700 dark:text-gray-300 text-sm" id="prev-biografia">Biografia do autor aparecerá aqui...</p>
                        </div>
                    </div>
                </div>
            </div>
