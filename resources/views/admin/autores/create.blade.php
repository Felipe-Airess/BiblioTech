            ...
            <form method="POST" action="{{ route('autores.store') }}" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="group">
                    ...
                    <textarea id="biografia" name="biografia" rows="4"
                        class="block w-full bg-gray-900 border border-gray-700 text-white focus:border-[#F59E0B] focus:ring-1 focus:ring-[#F59E0B] rounded-md shadow-sm transition-all duration-300 hover:border-gray-500">{{ old('biografia') }}</textarea>
                </div>
                ...
                <div class="bg-gray-900/50 p-4 border border-dashed border-gray-600 rounded-md hover:border-[#F59E0B] transition-colors duration-300">
                    <label for="foto" class="block text-xs font-bold text-gray-400 uppercase tracking-wider mb-3">Foto do Autor</label>
                ...
                <div class="bg-gray-900 border border-gray-700 shadow-xl rounded-md overflow-hidden flex flex-col max-w-sm mx-auto h-[480px] transition-all duration-500 hover:shadow-2xl hover:border-gray-500 hover:-translate-y-2">
                    ...
                    <div class="p-4 flex-1">
                        <div class="text-center mb-4">
                            ...
                            <h3 class="text-lg font-bold text-white" id="prev-nome">Nome do Autor</h3>
                            <p class="text-gray-400 text-sm" id="prev-nacionalidade">Nacionalidade</p>
                        </div>

                        <div class="space-y-2 text-sm">
                            <div>
                                <span class="text-gray-500">Data de Nascimento:</span>
                                <span class="text-white" id="prev-data">Não informada</span>
                            </div>
                        </div>

                        <div class="mt-4">
                            <p class="text-gray-300 text-sm" id="prev-biografia">Biografia do autor aparecerá aqui...</p>
                        </div>
                    </div>
                </div>
            </div>
