        ...
        <div class="flex w-full flex-wrap items-center justify-between gap-4">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <h1 class="font-serif text-2xl font-black text-slate-950 dark:text-white">Novo Autor</h1>
                    <p class="text-xs text-slate-500 dark:text-slate-400">Cadastro de nomes para o acervo</p>
                </div>
            </div>
    ...
    <div class="-mx-4 min-h-screen bg-gradient-to-b from-slate-100 via-blue-50 to-slate-100 px-4 py-8 dark:from-[#0f172a] dark:via-[#0f172a] dark:to-[#0b1120] sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
        <div class="fixed inset-0 z-0 pointer-events-none overflow-hidden" aria-hidden="true">
            <svg class="absolute inset-0 h-full w-full" xmlns="http://www.w3.org/2000/svg">
                <defs>
                    <pattern id="autor-create-dots" width="28" height="28" patternUnits="userSpaceOnUse">
                        <circle cx="1" cy="1" r="1" fill="#1E3A8A" opacity="0.08"/>
                    </pattern>
                </defs>
                <rect width="100%" height="100%" fill="url(#autor-create-dots)"/>
            </svg>
            <i class="ph ph-pen-nib absolute left-[8%] top-[14%] text-[42px] text-amber-500/25 dark:text-amber-300/10"></i>
            <i class="ph ph-book-open absolute right-[12%] top-[22%] text-[44px] text-blue-800/10 dark:text-blue-300/10"></i>
        </div>
        ...
        <main class="relative z-10 mx-auto max-w-7xl">
            @include('admin.autores._form', [
                ...
                'subtitle' => 'Registre os dados que ajudam o leitor e a equipe a reconhecer esse autor no catálogo.',
