            ...
            <form method="POST" action="{{ route('livros.store') }}" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="group">
                    ...
                    <textarea id="sinopse" name="sinopse" rows="4" 
                        class="block w-full bg-gray-900 border border-gray-700 text-white focus:border-[#F59E0B] focus:ring-1 focus:ring-[#F59E0B] rounded-md shadow-sm transition-all duration-300 hover:border-gray-500">{{ old('sinopse') }}</textarea>
                </div>
                ...
                <div class="group">
                    ...
                    <textarea id="preview" name="preview" rows="6" placeholder="Insira um trecho do livro para prévia..."
                        class="block w-full bg-gray-900 border border-gray-700 text-white focus:border-[#F59E0B] focus:ring-1 focus:ring-[#F59E0B] rounded-md shadow-sm transition-all duration-300 hover:border-gray-500">{{ old('preview') }}</textarea>
                </div>
                ...
                <div class="bg-gray-900/50 p-4 border border-dashed border-gray-600 rounded-md hover:border-[#F59E0B] transition-colors duration-300">
                    <label for="capa" class="block text-xs font-bold text-gray-400 uppercase tracking-wider mb-3">Capa do Livro</label>
        ...
        <div class="lg:col-span-5 flex flex-col justify-center">
            <div class="sticky top-6">
                ...
                <div class="bg-gray-900 border border-gray-700 shadow-xl rounded-md overflow-hidden flex flex-col max-w-sm mx-auto h-[480px] transition-all duration-500 hover:shadow-2xl hover:border-gray-500 hover:-translate-y-2">
                    ...
                    <div class="relative w-full h-56 bg-gray-800 border-b border-gray-700 flex items-center justify-center overflow-hidden">
                        <span id="prev-placeholder" class="text-gray-500 text-xs font-bold uppercase tracking-widest flex flex-col items-center transition-all duration-300">
                    ...
                    <div class="p-5 flex-1 flex flex-col">
                        <div class="flex justify-between items-start mb-2">
                            ...
                            <span id="prev-ano" class="text-[10px] font-bold text-gray-500">----</span>
                        </div>
                        
                        <h3 id="prev-title" class="text-xl font-black text-white leading-tight mb-1 transition-all" style="font-family: 'Merriweather', serif;">Título do Livro</h3>
                        <p id="prev-author" class="text-sm font-semibold text-gray-400 mb-4 transition-all">Autor da Obra</p>
                        ...
                        <div class="mt-auto pt-4 border-t border-gray-800 flex justify-between items-center">
                            <div class="text-[10px] text-gray-500 font-mono">ISBN: <span id="prev-isbn" class="text-gray-400">000-00-000-0000-0</span></div>
                            <div class="text-[10px] font-bold text-gray-400 uppercase bg-gray-800 px-2 py-1 rounded-md">Est: <span id="prev-stock" class="text-white">0</span></div>
                        </div>
                    </div>
                </div>
            </div>
