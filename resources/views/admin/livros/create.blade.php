        ...
        <div class="flex items-center justify-between w-full gap-4">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <h1 class="text-lg font-black text-slate-900 dark:text-white">Novo Livro</h1>
                </div>
            </div>
    ...
    <div class="-mx-4 px-4 py-10 bg-slate-50 dark:bg-[#0f172a] sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8 min-h-screen relative">
        ...
        <div class="fixed inset-0 z-0 pointer-events-none overflow-hidden" aria-hidden="true">
            <svg class="absolute inset-0 w-full h-full" xmlns="http://www.w3.org/2000/svg">
                <defs>
                    <pattern id="bg-dots-livros" width="28" height="28" patternUnits="userSpaceOnUse">
                        <circle cx="1" cy="1" r="1" fill="#93c5fd" opacity="0.08"/>
                    </pattern>
                </defs>
                <rect width="100%" height="100%" fill="url(#bg-dots-livros)"/>
            </svg>
            ...
            <i class="ph ph-pen bg-icon absolute left-[87%] top-[8%] text-[22px]"></i>
            ...
            <form method="POST" action="{{ route('livros.store') }}" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div class="group">
                        ...
                        <input id="quantidade" type="number" name="quantidade" min="0" value="{{ old('quantidade') }}" required
                            class="block w-full bg-white dark:bg-gray-900 border border-slate-200 dark:border-gray-700 text-slate-900 dark:text-white focus:border-[#F59E0B] focus:ring-1 focus:ring-[#F59E0B] rounded-md shadow-sm transition-all duration-300 hover:border-slate-300 dark:hover:border-gray-500" />
                    </div>
                    ...
                    <div class="group">
                        ...
                        <input id="data_publicacao" type="date" name="data_publicacao" value="{{ old('data_publicacao') }}" required
                            class="block w-full bg-white dark:bg-gray-900 border border-slate-200 dark:border-gray-700 text-slate-900 dark:text-white focus:border-[#F59E0B] focus:ring-1 focus:ring-[#F59E0B] rounded-md shadow-sm transition-all duration-300 hover:border-slate-300 dark:hover:border-gray-500" />
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="group">
                        ...
                        <input id="estante" type="text" name="estante" value="{{ old('estante') }}" placeholder="Ex: A3"
                            class="block w-full bg-white dark:bg-gray-900 border border-slate-200 dark:border-gray-700 text-slate-900 dark:text-white focus:border-[#F59E0B] focus:ring-1 focus:ring-[#F59E0B] rounded-md shadow-sm transition-all duration-300 hover:border-slate-300 dark:hover:border-gray-500" />
                    </div>
                    ...
                    <div class="group">
                        ...
                        <input id="localizacao" type="text" name="localizacao" value="{{ old('localizacao') }}" placeholder="Ex: Corredor 2, prateleira superior"
                            class="block w-full bg-white dark:bg-gray-900 border border-slate-200 dark:border-gray-700 text-slate-900 dark:text-white focus:border-[#F59E0B] focus:ring-1 focus:ring-[#F59E0B] rounded-md shadow-sm transition-all duration-300 hover:border-slate-300 dark:hover:border-gray-500" />
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 items-end">
                    <div class="md:col-span-2 group">
                        ...
                        <input id="isbn" type="text" name="isbn" value="{{ old('isbn') }}" required placeholder="000-00-000-0000-0"
                            class="block w-full bg-white dark:bg-gray-900 border border-slate-200 dark:border-gray-700 text-slate-900 dark:text-white focus:border-[#F59E0B] focus:ring-1 focus:ring-[#F59E0B] rounded-md shadow-sm transition-all duration-300 hover:border-slate-300 dark:hover:border-gray-500" />
                    </div>
                    ...
                    <div class="flex items-center bg-white dark:bg-gray-900 p-3 border border-slate-200 dark:border-gray-700 rounded-md h-[42px] hover:border-slate-300 dark:hover:border-gray-500 transition-colors">
                        <input id="e_bestseller" type="checkbox" name="e_bestseller" value="1" 
                ...
                <div class="group">
                    ...
                    <textarea id="sinopse" name="sinopse" rows="4" 
                        class="block w-full bg-white dark:bg-gray-900 border border-slate-200 dark:border-gray-700 text-slate-900 dark:text-white focus:border-[#F59E0B] focus:ring-1 focus:ring-[#F59E0B] rounded-md shadow-sm transition-all duration-300 hover:border-slate-300 dark:hover:border-gray-500">{{ old('sinopse') }}</textarea>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="group">
                        ...
                        <input id="editora" type="text" name="editora" value="{{ old('editora') }}"
                            class="block w-full bg-white dark:bg-gray-900 border border-slate-200 dark:border-gray-700 text-slate-900 dark:text-white focus:border-[#F59E0B] focus:ring-1 focus:ring-[#F59E0B] rounded-md shadow-sm transition-all duration-300 hover:border-slate-300 dark:hover:border-gray-500" />
                    </div>
                    ...
                    <div class="group">
                        ...
                        <input id="paginas" type="number" name="paginas" min="1" value="{{ old('paginas') }}"
                            class="block w-full bg-white dark:bg-gray-900 border border-slate-200 dark:border-gray-700 text-slate-900 dark:text-white focus:border-[#F59E0B] focus:ring-1 focus:ring-[#F59E0B] rounded-md shadow-sm transition-all duration-300 hover:border-slate-300 dark:hover:border-gray-500" />
                    </div>
                </div>
                ...
                <div class="group">
                    ...
                    <textarea id="preview" name="preview" rows="6" placeholder="Insira um trecho do livro para prévia..."
                        class="block w-full bg-white dark:bg-gray-900 border border-slate-200 dark:border-gray-700 text-slate-900 dark:text-white focus:border-[#F59E0B] focus:ring-1 focus:ring-[#F59E0B] rounded-md shadow-sm transition-all duration-300 hover:border-slate-300 dark:hover:border-gray-500">{{ old('preview') }}</textarea>
                </div>
                ...
                <div class="bg-slate-100 dark:bg-gray-900/50 p-4 border border-dashed border-slate-300 dark:border-gray-600 rounded-md hover:border-[#F59E0B] transition-colors duration-300">
                    <label for="capa" class="block text-xs font-bold text-slate-600 dark:text-gray-400 uppercase tracking-wider mb-3">Capa do Livro</label>
        ...
        <div class="lg:col-span-5 flex flex-col justify-center">
            <div class="sticky top-6">
                <label class="block text-xs font-bold text-slate-600 dark:text-gray-500 uppercase tracking-wider mb-4 border-b border-slate-200 dark:border-gray-700 pb-2">Pré-visualização</label>
                ...
                <div class="bg-white dark:bg-gray-900 border border-slate-200 dark:border-gray-700 shadow-xl rounded-md overflow-hidden flex flex-col max-w-sm mx-auto h-[480px] transition-all duration-500 hover:shadow-2xl hover:border-slate-300 dark:hover:border-gray-500 hover:-translate-y-2">
                    ...
                    <div class="relative w-full h-56 bg-slate-100 dark:bg-gray-800 border-b border-slate-200 dark:border-gray-700 flex items-center justify-center overflow-hidden">
                        <span id="prev-placeholder" class="text-slate-500 dark:text-gray-500 text-xs font-bold uppercase tracking-widest flex flex-col items-center transition-all duration-300">
                            <svg class="w-8 h-8 mb-2 opacity-50" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
                            Sem Capa
                        </span>
                        <img id="prev-img" src="" alt="Capa" class="absolute inset-0 w-full h-full object-cover hidden transition-all duration-500 hover:scale-105" />
                        
                        <div id="prev-badge" class="absolute top-0 right-0 bg-[#F59E0B] text-white text-[10px] font-black px-3 py-1 uppercase tracking-wider hidden shadow-md rounded-bl-md">
                            Bestseller
                        </div>
                    </div>
                    ...
                    <div class="p-5 flex-1 flex flex-col">
                        <div class="flex justify-between items-start mb-2">
                            <span id="prev-cat" class="text-[10px] font-bold text-[#F59E0B] uppercase tracking-widest border border-[#F59E0B]/50 bg-[#F59E0B]/10 px-2 py-0.5 rounded-md transition-all">Categoria</span>
                            <span id="prev-ano" class="text-[10px] font-bold text-slate-600 dark:text-gray-500">----</span>
                        </div>
                        
                        <h3 id="prev-title" class="text-xl font-black text-slate-900 dark:text-white leading-tight mb-1 transition-all" style="font-family: 'Merriweather', serif;">Título do Livro</h3>
                        <p id="prev-author" class="text-sm font-semibold text-slate-600 dark:text-gray-400 mb-4 transition-all">Autor da Obra</p>
                        
                        <p id="prev-synopsis" class="text-xs text-slate-600 dark:text-gray-500 line-clamp-4 mb-4 flex-1 transition-all">
                            Digite a sinopse ao lado para visualizar como o texto ficará ajustado no formato final do card do livro.
                        </p>
                        
                        <div class="mt-auto pt-4 border-t border-slate-200 dark:border-gray-800 flex justify-between items-center">
                            <div class="text-[10px] text-slate-600 dark:text-gray-500 font-mono">ISBN: <span id="prev-isbn" class="text-slate-700 dark:text-gray-400">000-00-000-0000-0</span></div>
                            <div class="text-[10px] font-bold text-slate-600 dark:text-gray-400 uppercase bg-slate-100 dark:bg-gray-800 px-2 py-1 rounded-md">Est: <span id="prev-stock" class="text-slate-900 dark:text-white">0</span></div>
                        </div>
                    </div>
                </div>
            </div>
