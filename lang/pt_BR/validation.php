...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | As linhas abaixo contêm as mensagens de erro padrão usadas pelo validador.
    | Sinta-se à vontade para ajustá-las conforme as necessidades da aplicação.
    |
    */
    ...
    'phone_prefix' => 'O campo :attribute deve conter um prefixo/DDD válido.',
